...
export default function AnalysisWorkspace({
  ...
  return (
    <div className="w-full space-y-6 bg-white min-h-screen p-2 sm:p-4 font-sans">
      ...
      {/* Main Analysis Form Setup Card */}
      <div className="w-full bg-white border-2 border-red-600 p-4 sm:p-6 shadow-[5px_5px_0px_0px_rgba(220,38,38,1)] space-y-5">
        <div className="flex items-center gap-2 border-b-2 border-red-600/20 pb-3">
